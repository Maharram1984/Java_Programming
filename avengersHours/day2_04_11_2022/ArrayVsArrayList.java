...
public class ArrayVsArrayList {
  /* ArrayList -> is a data structure, a member of collection framework
     ...
     Size is dynamic
     Has its own methods (unlike array)  add(),get(),remove()  how? */
    public static void main(String[] args) {
        ...
        int aaa = 100;
        Integer []bbb = {5,6,7,8,9};
        ArrayList<Integer> l = new ArrayList<>(Arrays.asList(aaa));
        ArrayList<Integer> m = new ArrayList<>(Arrays.asList(bbb));
