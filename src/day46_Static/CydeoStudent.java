...
public class CydeoStudent {
    ...
    // you can assign and declare at the same time, but it is not recommended,
    // we will use static block to assign
    static {
        System.out.println("Static block is running by default");
        System.out.println("Static block is running by default");
        batchNumber = 26;
