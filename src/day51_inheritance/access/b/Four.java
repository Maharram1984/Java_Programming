...
//        System.out.println(obj.four);
 ...
 /* line 13 is trying to directly access a protected variable outside the package.
    You cannot directly access any protected information outside the package
    line 19 we are able to access the two variable because it is inherited from the
    First class to the Four class, so the two variable belongs to the objects
    of the Four class (subclass)    */
}