...
public class CurrencyConverter {
     /*
     create a method that will accept a currency type(String) and a
     currency amount (double)[as dollars] and convert the currency from dollars to a different type
    ...
    public static void main(String[] args) {
        System.out.println(converter("rupee", 100)); // convert(next(),nextDouble())
    }
