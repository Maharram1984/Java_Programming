...
public class Inheritance {
     /*
       ...
       What is inherited ?
        ...
        - All default variables and methods (if parent and child needs to be in same package ) (PACKAGE-PRIVATE)
       What is not inherited ?
        - Private variables and methods CAN NOT be inherited (Access them with GETTER / SETTER )
        - Constructors CAN NOT be inherited
       Constructor
         - The parent class constr always executes before child constr
     ...
     OVERRIDING
        Why we need ?
            ...
            but the method is inadequate for child classes
                Shape --> area ()
                Rectangle --> area()
                Circle --> area()
                ...
         ...
         RULES :
             ...
             - private, final and static ones CAN NOT BE OVERRIDE
        Method OVERLOADING
