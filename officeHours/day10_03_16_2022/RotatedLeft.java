...
public class RotatedLeft {
    public static void main(String[] args) {
       /*
        ...
        PasswordCheck=0  --> x[0]=x[1]   --> 2,2,3,4,5
        PasswordCheck=1  --> x[1]=x[2]   --> 2,3,3,4,5
        PasswordCheck=2  --> x[2]=x[3]   --> 2,3,4,4,5
        PasswordCheck=3  --> x[3]=x[4]   --> 2,3,4,5,5

        x[x.length-1]=temp;  --> 2,3,4,5,1

        Formula
            x[PasswordCheck]=x[PasswordCheck+1];
